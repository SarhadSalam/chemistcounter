...
public class Normal
{
	 ...
	 */
	public static ArrayList<ElementDetails> manager(String chemicalCompound)
	{
//		Split Based on capital letters
		String[] splitElement = chemicalCompound.split("(?=[A-Z])");
		ArrayList<ElementDetails> chemicalList = new ArrayList<>();
//			Detects compounds
		for( String elementName : splitElement )
		{
			if( !elementName.equals("") )
			{
				ElementDetails element = new ElementDetails();
